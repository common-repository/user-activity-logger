...
if (class_exists('Klick_Ual_Notifier')) return;

/**
 * Class Klick_Ual_Notifier
 */
class Klick_Ual_Notifier {
	...
	/**
	 * Klick_Ual_PHP_Notifier constructor
	...
	public function __construct() {
		...
		$folder = opendir(KLICK_UAL_PLUGIN_MAIN_PATH . 'notices');
	...
	public function add_noitice($notice_file) {
		...
		$notice_file = KLICK_UAL_PLUGIN_MAIN_PATH . 'notices' . '/' . $notice_file;
