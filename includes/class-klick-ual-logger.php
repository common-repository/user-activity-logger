...
require_once('class-klick-ual-abstract-logger.php');
require_once('class-klick-ual-logger.php');

if (class_exists('Klick_Ual_Logger')) return;

/**
 * Class Klick_Ual_Logger
 */
class Klick_Ual_Logger {
	...
	/**
	 * Get array of Klick_Ual_Logger instances
	 ...
	 * @return array mixed
	 */
	public function klick_ual_get_loggers() {

		$loggers = array();

		// Can be enhanced new more logger class here
		$loggers_classes = array(
				'Klick_Ual_EMAIL_Logger' => KLICK_UAL_PLUGIN_MAIN_PATH . 'includes/class-klick-ual-email-logger.php',
				'Klick_Ual_PHP_Logger' => KLICK_UAL_PLUGIN_MAIN_PATH . 'includes/class-klick-ual-php-logger.php',
		);

		$loggers_classes = apply_filters('klick_ual_loggers_classes', $loggers_classes);
		...
		$loggers = apply_filters('klick_ual_loggers', $loggers);
